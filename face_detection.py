        ...
        if len(rects) > 0:
            ...
            if len(rectsf) > 0:
                ...
                cv2.rectangle(
                    ...
                    (shape[12][0], shape[33][1]),
                    (0, 255, 0),
                    0,
                )
                cv2.rectangle(
                    face_frame,
                    (shape[4][0], shape[29][1]),
                    (shape[48][0], shape[33][1]),
                    (0, 255, 0),
                    0,
                )

                ROI1 = face_frame[
                    shape[29][1] : shape[33][1],  # right cheek
                    shape[54][0] : shape[12][0],
                ]

                ROI2 = face_frame[
                    shape[29][1] : shape[33][1],  # left cheek
