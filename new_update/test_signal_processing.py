    ...
    while True:
        ...
        if len(aligned_shape) == 68:
            ...
            cv2.rectangle(
                ...
                (aligned_shape[1][0], aligned_shape[4][1]),
                (0, 255, 0),
                0,
            )
            ...
            cv2.rectangle(
                ...
                (aligned_shape[3][0], aligned_shape[4][1]),
                (0, 255, 0),
                0,
            )
        ...
        if L == 100:
            ...
            filtered_data = sp.butter_bandpass_filter(
                interpolated_data, (bpm - 20) / 60, (bpm + 20) / 60, fps, order=3
            )
            # print(fps)
        ...
        with open("a.txt", mode="a+") as f:
            f.write(
                "time: {0:.4f} ".format(times[-1]) + ", HR: {0:.2f} ".format(bpm) + "\n"
            )
